...
const textContent = {
  h4: "Rólunk",
  p: "Mióta megnyitottuk Budapest első igazi spanyol colmadóját a Bartókon, a Szent Gellért tér közvetlen közelében, elkötelezetten igyekszünk megnyerni minden hozzánk betérő vendég szívét.",
...
const textContentEn = {
  h4: "About us",
  p: 'Since we opened Budapest’s first Spanish colmado next to St. Gellért Square, our mission has been to win the hearts of every guest who walks through our doors. ',
  p1: "In our bar, you’ll discover cured hams, delectable cheeses, olives, and a variety of culinary delights. On the shelves of our store, you'll find special creams and sauces, high-quality canned fish, wines, beers, cavas, and more, all sourced directly from Spain.",
